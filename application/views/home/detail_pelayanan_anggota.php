<div class="slim-mainpanel">
    <div class="container">
        ...
        <div class="section-wrapper">
                                ...
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <span>
                                            ...
                                            <p style="color: black; font-weight: bold; text-transform: capitalize;" class="pull-right"><?php echo $hari_ini; ?>, <?php echo date('d') . " " . $bulan_ini . " " . date('Y'); ?></p>
                                        </span>
                                    </div><!-- media-body -->
                                </div><!-- media -->
                            </div><!-- card -->
                                ...
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <span>
                                            ...
                                            <p style="color: black; font-weight: bold; text-transform: capitalize;" class="pull-right"><?php echo $bulan_ini . " " . date('Y'); ?></p>
                                        </span>
                                    </div><!-- media-body -->
                                </div><!-- media -->
                            </div><!-- card -->
                                ...
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <span>
                                            ...
                                            <p style="color: black; font-weight: bold; text-transform: capitalize;" class="pull-right"><?php echo date('Y'); ?></p>
                                        </span>
                                    </div><!-- media-body -->
                                </div><!-- media -->
                            </div><!-- card -->
                                ...
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <span>
                                            ...
                                            <p style="color: black; font-weight: bold; text-transform: capitalize;" class="pull-right">Keseluruhan Hingga Tahun <?php echo date('Y'); ?></p>
                                        </span>
                                    </div><!-- media-body -->
                                </div><!-- media -->
                            </div><!-- card -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4>Berdasarkan Jumlah Surat</h4>
                    <hr>
                </div>
            ...
            <div class="row">
                <?php foreach ($graph_anggota_hari as $graph_anggota_hari) {
                    $tanggal_angka_anggota[] = date("d M Y", strtotime($graph_anggota_hari->tanggal_angka));
