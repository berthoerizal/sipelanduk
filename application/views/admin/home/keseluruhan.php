        ...
        <div class="col-md-12 id=" menu">
          <div class="user-btn-wrapper">
            ...
            <span class="pull-right">
              ...
              <a href="<?php echo base_url('admin/home/keseluruhan'); ?>" class="btn btn-outline-primary">
            ...
            <?php foreach ($pelayanan as $pelayanan) { ?>
              <?php if ($pelayanan->slug_layanan == 'kedatangan') { ?>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" style="margin-bottom: 20px;">
                  <a href="<?php echo base_url('admin/home/pendaftaran_penduduk_kedatangan_anggota/' . $this->encrypt->encode($pelayanan->id_layanan)); ?>">
              ...
              <?php } elseif ($pelayanan->slug_layanan == 'perpindahan') { ?>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" style="margin-bottom: 20px;">
                  <a href="<?php echo base_url('admin/home/pendaftaran_penduduk_perpindahan_anggota/' . $this->encrypt->encode($pelayanan->id_layanan)); ?>">
                    <div class="card card-status">
                      <div class="media">
                        <div class="media-body">
                          <?php if ($pelayanan->jumlah_angka == NULL) {
