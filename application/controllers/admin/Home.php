...
class Home extends CI_Controller
{
	...
	public function index()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'admin/home/list', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU', 'last_update' => $last_update, 'kedatangan_anggota' => $kedatangan_anggota, 'perpindahan_anggota' => $perpindahan_anggota);
	...
	public function bulan()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'admin/home/bulan', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU', 'last_update' => $last_update, 'kedatangan_anggota' => $kedatangan_anggota, 'perpindahan_anggota' => $perpindahan_anggota);
		$this->load->view('admin/layout/wrapper', $data, FALSE);
	}
	...
	public function tahun()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'admin/home/tahun', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU', 'last_update' => $last_update, 'kedatangan_anggota' => $kedatangan_anggota, 'perpindahan_anggota' => $perpindahan_anggota);
		$this->load->view('admin/layout/wrapper', $data, FALSE);
	}
	...
	public function keseluruhan()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'admin/home/keseluruhan', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN', 'last_update' => $last_update, 'kedatangan_anggota' => $kedatangan_anggota, 'perpindahan_anggota' => $perpindahan_anggota);
		$this->load->view('admin/layout/wrapper', $data, FALSE);
	}
	...
	public function pendaftaran_penduduk($id_layanan)
	{
		...
		$graph_hari = $this->angka_model->graph_perhari($id_layanan);

		$data = array(
			'title' => $detail_pelayanan->nama_layanan,
			'status_layanan' => $detail_pelayanan->status_layanan,
	...
	public function pendaftaran_penduduk_kedatangan_anggota($id_layanan)
	{
		...
		$graph_hari = $this->angka_model->graph_perhari($id_layanan);
		$graph_anggota_hari = $this->angka_model->graph_perhari($id_anggota);
		...
		$data = array(
			...
			'graph_hari' => $graph_hari,
			'graph_anggota_hari' => $graph_anggota_hari
		);
		$this->load->view('admin/layout/wrapper', $data, FALSE);
	}
