...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'home/list', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU HARI INI');
	...
	public function pencatatan_sipil()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'home/pencatatan_sipil', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENCATATAN SIPIL - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU HARI INI');
		$this->load->view('layout/wrapper', $data, FALSE);
	}
