...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'home/list', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU', 'last_update' => $last_update);
	...
	public function bulan()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'home/bulan', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU', 'last_update' => $last_update);
		$this->load->view('layout/wrapper', $data, FALSE);
	}
	...
	public function tahun()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'home/tahun', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN RIAU', 'last_update' => $last_update);
		$this->load->view('layout/wrapper', $data, FALSE);
	}
	...
	public function keseluruhan()
	{
		...
		$data = array('title' => 'Provinsi Kepulauan Riau', 'isi' => 'home/keseluruhan', 'pelayanan' => $pelayanan, 'pelayanan_all' => $pelayanan_all, 'sub_pelayanan' => 'PENDAFTARAN PENDUDUK - TOTAL PELAYANAN PROVINSI KEPULAUAN', 'last_update' => $last_update);
		$this->load->view('layout/wrapper', $data, FALSE);
	}
